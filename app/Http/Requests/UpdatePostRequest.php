...
class UpdatePostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        // Content validation (optional for all languages)
        ...
        $validationRules['exhibition_id'] = ['required', 'integer', 'exists:exhibitions,id'];
    ...
    public function messages(): array
    {
        ...
        foreach ($languages as $language) {
            ...
            $messages["name.{$lang}.required"] = "Il nome del post in {$langName} è obbligatorio.";
            $messages["name.{$lang}.string"] = "Il nome del post in {$langName} deve essere una stringa.";
            $messages["name.{$lang}.max"] = "Il nome del post in {$langName} non può superare 200 caratteri.";
            $messages["description.{$lang}.string"] = "Il contenuto del post in {$langName} deve essere una stringa.";
            $messages["description.{$lang}.max"] = "Il contenuto del post in {$langName} non può superare 50000 caratteri.";
        ...
        $messages['exhibition_id.exists'] = 'Correggi la scelta della collezione.';
